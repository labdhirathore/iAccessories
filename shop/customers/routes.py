from flask import render_template, session, request, redirect, url_for, flash, current_app, make_response, render_template_string
...
def get_pdf(invoice):
    if current_user.is_authenticated:
        ...
        if request.method == "POST":
            ...
            rendered = render_template('customers/pdf.html', invoice=invoice, tax=tax, grandTotal=grandTotal,
                                       customer=customer, orders=orders)
